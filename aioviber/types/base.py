...
class MetaViberObject(type):
    ...
    def __new__(mcs: typing.Type[T], name: str, bases: typing.Tuple[typing.Type], 
        ...
        cls = super(MetaViberObject, mcs).__new__(mcs, name, bases, namespace)
        ...
        for base in bases:
            if not isinstance(base, MetaViberObject):
                continue
...
class ViberObject(ContextInstanceMixin, metaclass=MetaViberObject):
    ...
    @property
    def viber_types(self) -> typing.List['ViberObject']:
        return type(self).viber_types
    ...
    def to_python(self) -> typing.Dict[str, typing.Any]:
        ...
        for name, value in self.values.items():
            ...
            if isinstance(value, ViberObject):
    ...
    def __eq__(self, other: 'ViberObject') -> bool:
